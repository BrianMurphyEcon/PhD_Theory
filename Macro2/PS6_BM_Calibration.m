...
%To Import the data, click the home tab, then import the data. Once the
%data is imported, run the following code.
...
phi = (1-theta)*mean((C_div_Y).^-1)*((1-h)/h);
...
% AR(1) Process can be created as followed, to get rho and eps
...
parameters=[alpha, beta, eta, phi, lambda, theta, delta, rho, eps];
